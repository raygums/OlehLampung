...
<div class="container-main py-8 max-w-lg mx-auto text-center">
    ...
    <a href="{{ route('checkout.success', $order) }}" class="text-amber text-sm mt-4 inline-block hover:underline">Lewati (untuk testing) →</a>
</div>
@endsection
@push('scripts')
...
document.getElementById('pay-button').addEventListener('click', function(){
    window.snap.pay('{{ $snapToken }}', {
        ...
        onPending: function(r){ window.location.href = '{{ route("checkout.success", $order) }}'; },
        onError: function(r){ alert('Pembayaran gagal. Silakan coba lagi.'); },
