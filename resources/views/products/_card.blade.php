<div class="card group">
    ...
    <div class="p-4 md:p-5">
        <p class="text-xs text-amber-dark font-semibold uppercase tracking-wide mb-2">{{ $product->category->name }}</p>
        <a href="{{ route('products.show', $product) }}" class="font-semibold text-navy text-sm hover:text-amber transition-colors line-clamp-2 mb-2.5 block leading-snug">{{ $product->name }}</a>
